  ...
  return (
    ...
    <span className="text-orange-500 font-playfair">Game Developer</span>
        ...
        <p className="mt-6 text-lg md:text-xl max-w-2xl font-montserrat text-gray-300">
          Specialising in Unreal Engine Blueprints and C++, I create robust gameplay systems, user-friendly player controls and engaging mechanics - 
          From prototype to fully finished product. I am also well-versed with animation pipelines and 3D asset creation workflows allowing me to help ensure seamless integration across every stage of development.
        </p>
